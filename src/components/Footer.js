...
export default function Footer() {
  return (
    <section className="md:px-6 bg-prbred pt-6 md:pt-24 lg:pt-32 pb-32 md:pb-6">
        ...
        <div className="w-full flex flex-wrap">
          <div className="w-full md:w-10/12 ml-auto">
            <div className="flex flex-wrap items-end md:-mx-3 md:pl-6">
              <div className="w-full md:w-auto order-1 md:order-1 md:px-3 overflow-hidden mt-32 md:mt-0 mb-16 md:mb-0 flex justify-between items-center">
                <img
                  src={LogoPicture.src}
                  alt="logo"
      ...
      <div className="w-full md:w-10/12 ml-auto mt-0 md:mt-24 lg:mt-32 md:pl-12 lg:pl-4 px-4 md:px-0">
        <ul className="flex flex-wrap border-t border-black border-b">
          ...
          <li className="ml-auto block border-l border-black invert-select">
            ...
            >
              ...
              <span className="hidden invert-select md:block">
                +84 768 647 058
              </span>
            </a>
          </li>
